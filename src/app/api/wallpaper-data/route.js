...
const getCachedWallpaperUser = (token) =>
    unstable_cache(
        async () =>
        ...
        ["wallpaper-user", token],
        { revalidate: 300, tags: ["wallpaper-user", "user-profile", "wallpaper-settings"] }
    )();

const getCachedWallpaperHabits = (userId) =>
    unstable_cache(
        async () =>
        ...
        ["wallpaper-habits", userId],
        { revalidate: 60, tags: ["habits", "habit-logs"] }
    )();

const getCachedWallpaperGoal = (userId) =>
    unstable_cache(
        async () => {
        ...
        ["wallpaper-goal", userId],
        { revalidate: 300, tags: ["goals"] }
    )();

const getCachedWallpaperReminders = (userId) =>
    unstable_cache(
        async () =>
        ...
        ["wallpaper-reminders", userId],
        { revalidate: 120, tags: ["reminders"] }
    )();
